...
import {
  ...
  AlertCircle, DollarSign, Bike, Pencil
} from 'lucide-react';
...
const EditServiceModal: React.FC<{
  ...
  const [serviceType,   setService]  = useState<ServiceType>(record.serviceType);
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select value={serviceType} onChange={e => handleServiceChange(e.target.value as ServiceType)}
                className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-red-400 bg-white cursor-pointer">
            ...
            {serviceType === 'Oil Change' && reminderStatus && (
              <div>
                <label className="block text-xs font-semibold text-slate-700 mb-1.5">Reminder Status</label>
                <select value={reminderStatus} onChange={e => setReminder(e.target.value as any)}
                  className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm outline-none focus:border-red-400 bg-white cursor-pointer">
